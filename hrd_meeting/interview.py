    ...
    def do_sendsms(self, cr, uid, ids, context=None):
        ...
        for event in self.browse(cr, uid, ids, context):
            ...
            for att in event.applicant_ids:
                ...
                if mobile != False:
                    payload = {'username': 'tag', 'password': 'p4ssw0rd','hp':mobile,'message':'Salam, Kami mengundang Sdr/i '+att.partner_name+' mengikuti Tes tulis u/ posisi '+att.job_id.name+' pada tanggal: '+dates+' Jam '+jam+' tempat : '+event.location+'. Mohon konfirmasi kehadiran dengan menghubungi CP : Ridwan 083822761725. Terimakasih'}
